...
from app.core.safety import _sanitize_value as shared_sanitize_value, _sanitize_string as shared_sanitize_string

def _sanitize_string(s: str) -> str:
    return shared_sanitize_string(s)

def _sanitize_value(val: Any, tags: List[str] | None = None, registry: dict | None = None) -> Any:
    return shared_sanitize_value(val, tags, registry)
